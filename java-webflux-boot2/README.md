...
EU CAPTCHA verification client for Spring WebFlux applications (reactive, Spring Boot 2 / Spring 5).
...
**Requirements:** Java 8, Spring Boot 2 / Spring WebFlux (Project Reactor)
...
<dependency>
  ...
  <artifactId>eu-captcha-java-webflux-boot2</artifactId>
...
```groovy
implementation "com.myrasec:eu-captcha-java-webflux-boot2:1.0.0"
```
