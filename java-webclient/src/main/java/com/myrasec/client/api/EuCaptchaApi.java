...
public class EuCaptchaApi {
     ...
     */
    private ResponseSpec verifyClientTokenRequestCreation(@javax.annotation.Nonnull VerifyRequest verifyRequest) throws WebClientResponseException {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<VerifyResponse> verifyClientToken(@javax.annotation.Nonnull VerifyRequest verifyRequest) throws WebClientResponseException {
        ParameterizedTypeReference<VerifyResponse> localVarReturnType = new ParameterizedTypeReference<VerifyResponse>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<VerifyResponse>> verifyClientTokenWithHttpInfo(@javax.annotation.Nonnull VerifyRequest verifyRequest) throws WebClientResponseException {
        ParameterizedTypeReference<VerifyResponse> localVarReturnType = new ParameterizedTypeReference<VerifyResponse>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec verifyClientTokenWithResponseSpec(@javax.annotation.Nonnull VerifyRequest verifyRequest) throws WebClientResponseException {
